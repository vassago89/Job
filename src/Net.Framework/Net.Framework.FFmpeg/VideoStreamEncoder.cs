...
namespace FFmpeg.AutoGen.Example
{
    public sealed unsafe class VideoStreamEncoder : IDisposable
    {
        ...
        public VideoStreamEncoder(Stream stream, int fps, Size frameSize, AVCodecID codecId = AVCodecID.AV_CODEC_ID_H264, AVPixelFormat format = AVPixelFormat.AV_PIX_FMT_YUV420P)
        {
            _stream = stream;
